...
stock_code = ['F', 600885, 603259, 600276, 600196, 603899, 603986, 603833, 603806, 603369, 601877, 601607, 601238, 601186, 601100, 600875, 600741, 600406, 600132, 600104, 2415, 2050, 895, 733, 661, 603288, 600845, 600690, 600660, 600600, 600332, 600085, 300628, 300124]
...
stock_name = ['Ford', '宏发股份', '药明康德', '恒瑞医药', '复星医药', '晨光股份', '兆易创新', '欧派家居', '福斯特', '今世缘', '正泰电器', '上海医药', '广汽集团', '中国铁建', '恒立液压', '东方电气', '华域汽车', '国电南瑞', '重庆啤酒', '上汽集团', '海康威视', '三花智控', '双汇发展', '振华科技', '长春高新', '海天味业', '宝信软件', '海尔智家', '福耀玻璃', '青岛啤酒', '白云山', '同仁堂', '亿联网络', '汇川技术']
