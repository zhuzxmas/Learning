...
for iii in range(0, len(stock_code)):  # 在所有的沪深300成分股里面进行查询..
            ...
            if stock_file_str in key:
                ...
                if stock == 'F':
                    if check_item_name == 'yearly':
                        ...
                        # temp_output = stock_output_combined.join(yearly_report_from_OD, lsuffix='', rsuffix='_y', how='left')
                    ...
                    if check_item_name == 'yearly':
                        ...
                        # if (day_one - latest_report_notice_date).days < 0:
                            ...
                            ### to update data, keep the info from East Money, and remove the outdated info from OD
    ...
    if stock != 'F':
        ...
        try:
            print('------- To get the Seasonly stock price range from Eas Mon ------------\n')
            print('Please Note: the stock price for the latest period is just to as of now...\n')
