...
# create sharing link can be done via Microsoft Graph API: endpoint is 'https://graph.microsoft.com/v1.0/me/drive/items/{item-id}/createlink', check the API document in 'https://learn.microsoft.com/en-us/graph/api/driveitem-createlink?view=graph-rest-1.0'. a
