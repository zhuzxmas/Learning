...
(`index.html`, `app.js`, `stock-realization.js`, `valuation.js`, `style.css`, `categories.js`, `msal-browser.min.js`).
...
the static files:
```
app.js  stock-realization.js  valuation.js  categories.js  index.html  msal-browser.min.js  style.css
```
