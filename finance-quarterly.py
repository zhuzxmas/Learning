...
# for iii in range(5,7):
    ...
    stock_target_sales = stock_target.get_cashflow(freq='quarterly',proxy=proxy_add)
    stock_target_balance_sheet = stock_target.get_balance_sheet(freq='quarterly',proxy=proxy_add)
    stock_target_income = stock_target.get_income_stmt(freq='quarterly',proxy=proxy_add)
