...
# for iii in range(5,7):
    ...
    if stock_code: # to be updated later
        ...
        params_eastmoney_balance_sheet = {
            ...
            'sty': 'F10_FINANCE_G{}'.format(p_balance_sheet),
            'filter': '(SECUCODE="{}")'.format(stock_code),
            'sr': '-1',
            'st': 'REPORT_DATE',
            'source': 'HSF10',
            'client': 'PC',
            'v': '035376456081999563',
        }

    else:
        url = "https://datacenter.eastmoney.com/securities/api/data/v1/get"
        params_eastmoney_income = {
            'reportName': 'RPT_USF10_FN_{}'.format(p_income),
            'columns': 'SECUCODE,SECURITY_CODE,SECURITY_NAME_ABBR,REPORT,REPORT_DATE,STD_ITEM_CODE,AMOUNT',
            'quoteColumns': '',
            'filter': '(SECUCODE="GOOGL.O")(REPORT in ("2024/Q6","2024/Q1","2023/FY","2023/Q9","2023/Q6","2023/Q1"))',
            'pageNumber': '',
            'pageSize': '',
            'sortTypes': '1,-1',
    ...
    stock_0_TotalRevenue = df_income_stock['TOTAL_OPERATE_INCOME']/100000000 #销售额
