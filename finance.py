...
stock_0_CurrentAssets.name = '流动资产'
stock_0_CurrentLiabilities = stock_target_balance_sheet.loc['CurrentLiabilities']/100000000 #流动负债
stock_0_CurrentLiabilities.name = '流动负债'
stock_0_CurrentAssets_vs_Liabilities = stock_target_balance_sheet.loc['CurrentAssets']/stock_target_balance_sheet.loc['CurrentLiabilities'] #流动资产与流动负债之比
stock_0_CurrentAssets_vs_Liabilities.name = '流动资产与流动负债之比'
...
stock_0_profit_margin.name = '每股收益 稀释后'
...
stock_price_less_than_PE_ratio.name = '市盈率15对应的目标股价'
...
stock_0_BookValue_per_Share.name = '每股账面价值'
stock_price_less_than_BookValue_ratio = stock_0_BookValue_per_Share*1.5 #按账面价值计算出来的目标股价
stock_price_less_than_BookValue_ratio.name = '每股账面价值的1.5倍'

stock_output = pd.concat([stock_0_TotalRevenue, stock_0_TotalAssets, stock_0_EBIT, stock_0_CurrentAssets, stock_0_CurrentLiabilities, stock_0_CurrentAssets_vs_Liabilities, stock_0_TotalNonCurrentLiabilitiesNetMinorityInterest, stock_0_CurrentAssets_minus_TotalNonCurrentLiabilities, stock_0_profit_margin, stock_0_BookValue_per_Share, stock_price_less_than_BookValue_ratio, stock_price_less_than_PE_ratio], axis=1)
